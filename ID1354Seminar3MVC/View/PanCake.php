...
<html lang="en">
    ...
    <body >
        <h1 class="headMain" >Tasty Recipes</h1>
         <nav>
                <ul class="navbar">
                    <li class="navbar1"><a href="View/recipes.php">Index</a></li>
                    <li class="navbar1"><a href="View/Calendar.php">Calendar</a></li>
                    <li class="navbar1"> <a href="View/MeatBall.php">Lunch</a></li>
                    <li class="navbar1"><a href="View/PanCake.php">Dessert</a></li>
                    <li class="navbar1"><a href='Model/Logout.php'>Logout</a></li>
                </ul>
            </nav>
